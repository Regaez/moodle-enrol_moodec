...
require_capability('enrol/moodec:config', $context);

$PAGE->set_url('/enrol/moodec/edit.php', array('courseid' => $course->id));
...
if ($instances = $DB->get_records('enrol', array('courseid' => $course->id, 'enrol' => 'moodec'), 'id ASC')) {
...
$mform = new enrol_moodec_edit_form(null, array($instance, $plugin, $context));
...
$PAGE->set_title(get_string('pluginname', 'enrol_moodec'));
$PAGE->set_heading($course->fullname);

echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('pluginname', 'enrol_moodec'));
$mform->display();
echo $OUTPUT->footer();
